...
from exchange_monitor.infrastructure.providers.awesomeapi_provider import AwesomeApiProvider
from exchange_monitor.infrastructure.providers.exceptions import ProviderError
